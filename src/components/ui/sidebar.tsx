...
const navItems = [
  ...
  { label: 'Market Prices', icon: 'trending_up', href: '/dashboard/farmer/prices' },
  { label: 'Apply Loan', icon: 'payments', href: '/dashboard/farmer/loans' },
    ...
    <aside className="hidden lg:flex flex-col w-72 bg-surface border-r border-outline-variant h-screen sticky top-0">
      <div className="p-8">
        <div className="flex items-center gap-2 mb-10">
          ...
          <span className="text-xl font-black text-primary tracking-tight">Krishi Hub</span>
        </div>
